...
if __name__=='__main__':
    ...
    f.Close()
    with Pool() as p:
        p.starmap(fit_era, [('data','C'), ('data','D'), ('dataE','E'), ('dataE','F'), ('dataE2','F'), ('dataE','G'), ('data_control','C'), ('data_control','D1'), ('data_control','D2'), ('data_controlE','E'), ('data_controlE','F'), ('data_controlE','G')])
